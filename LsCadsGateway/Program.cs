using LsCadsGateway.Example.Endpoints;
using LsCadsGateway.Example.Services;
using LsCadsGateway.Utils;
using LsCadsGateway.Utils.Http;
using LsCadsGateway.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsCadsGateway.Config;
using LsCadsGateway.Utils.Logging;
using Serilog;
